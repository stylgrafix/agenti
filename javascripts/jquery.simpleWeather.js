 ...
 * information for any location using Yahoo! simpleweather.
 *
...
(function($) {
	...
	$.extend({
		simpleWeather: function(options){
			...
			if(options.location !== '') {
				weatherUrl += 'select * from sweather.forecast where location in (select id from simpleweather.search where query="'+options.location+'") and u="'+options.unit+'"';
					...
					if(data !== null && data.query.results !== null && data.query.results.channel.description !== 'Yahoo! Weather Error') {
						$.each(data.query.results, function(i, result) {
							...
							var simpleweather = {
								...
								codice:result.item.condition.code,
